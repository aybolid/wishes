<script lang="ts">
  ...
  const buttonVariants = cva(
    "rounded-sm w-fit transition-all duration-150 ease-in-out disabled:opacity-60 disabled:pointer-events-none inline-flex items-center justify-center gap-2",
    {
      variants: {
        variant: {
